...
class FinancialStatementSerializer(serializers.Serializer):
    ...
    accounting_loss_before_tax = serializers.DecimalField(max_digits=15, decimal_places=2, allow_null=True)
    accounting_loss_after_tax = serializers.DecimalField(max_digits=15, decimal_places=2, allow_null=True)
...
class FinancialDataSerializer(serializers.Serializer):
    ...
    financial_statement = FinancialStatementSerializer(many=True, required=False, allow_null=True)
